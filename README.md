...
├── REFERENCE/                   ← 44条规则数据库
│   ├── f000.md                  ← 全量规则索引
│   ├── f001.md ~ f011.md        ← A组：核心认知 + 课程原文
│   ├── f012.md ~ f017.md        ← B组：女性识别体系
│   ├── f018.md ~ f020.md        ← C组：男性自我建设
│   ├── f021.md ~ f024.md        ← D组：聊天系统
│   ├── f025.md ~ f026.md        ← E组：约会执行系统
│   ├── f027.md ~ f029.md        ← F组：长期关系与特殊场景
│   └── f030.md ~ f043.md        ← H组：视频逐字转写库
├── docs/
│   └── demo.svg                 ← 效果演示动画
├── .github/
